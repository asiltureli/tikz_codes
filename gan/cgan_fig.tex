...
\begin{tikzpicture}
	...
	\draw[-stealth, thick] (z) -- node[above] {$G(\boldsymbol{z\textcolor{red}{|y}},\theta_{g})$} node[below] {generator} (x);
	\node[left=of z] (i) {};
	...
	\draw[-stealth, thick] (D) -- node[above] {$D(\boldsymbol{x\textcolor{red}{|y}},\theta_{d})$} node[below] {discriminator} (out);
